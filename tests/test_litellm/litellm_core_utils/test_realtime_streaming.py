...
# ---------------------------------------------------------------------------
# XAIRealtimeNormalizer.normalize()/.should_drop() unit tests live in
# tests/test_litellm/llms/xai/realtime/test_xai_realtime_transformation.py,
# mapped to litellm/llms/xai/realtime/transformation.py where the class is
# defined. patch_outgoing_session() tests stay here since they exercise
# RealTimeStreaming's session.update forwarding path.
# ---------------------------------------------------------------------------
