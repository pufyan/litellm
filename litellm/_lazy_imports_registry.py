...
UTILS_NAMES = (
    ...
    "supports_native_transcription",
    "supports_turn_detection",
...
_UTILS_IMPORT_MAP = {
    ...
    "supports_native_transcription": (".utils", "supports_native_transcription"),
    "supports_turn_detection": (".utils", "supports_turn_detection"),
